package com.vova_cons.hundread_games.p001_arkanoid.services.game_speed_service;
...
public class GameSpeedServiceV1 implements GameSpeedService {
    private final ArkanoidGame core;

    public GameSpeedServiceV1(ArkanoidGame core) {
        this.core = core;
    }
